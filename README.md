...
[![Built for TMAKER](https://img.shields.io/badge/Built%20for-TMAKER-fbbf24?style=for-the-badge&logo=x&logoColor=white)](https://x.com/tibo_maker)

![GHSpark Demo](./public/og.png)
...
**GHSpark** is built for makers who want to stay ahead of the curve. We don't just look at absolute star counts; we track **Spark Velocity**.
...
### 1. Clone & Install
```bash
git clone https://github.com/Ouranos27/ghspark.git
cd ghspark
bun install
```
...
---
*Built for the TMAKER 48h Challenge*
